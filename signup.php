  ...
  <body>
    ...
    <div class='container-fluid '>
      <div class='row mt-3 '>
        ...
        <div class='col pt-4 bg-light text-center shadow-sm'>
          <img src='images/logo.jpeg' alt='' class='logo' height='120px' width='120px'>
          <h3 class='pt-3 pb-4 fw-bold'>Welcome To My Homestay</h3>
          ...
          <input type='checkbox' class='form-check-input' id='Check1' required>
                <label class='form-check-label ' for='Check1'>I agree to the My Homestay <a href="#">User Agreement</a> and <a href="#">Privacy Policy</a>.</label>
          </div>
               
             
          <input type='submit' class='btn btn-lg form-control fw-bold text-light mb-3' style=' background-color: #1f1f1f' name='btnsignup' value='Join Homestay'><hr>
    ...
    <?php
          ...
          if(isset($_REQUEST["btnsignup"])){
              ...
              $flag=0;
              include 'db.php';
              $qry1="SELECT user_email, user_name FROM user_details";
              ...
              if($flag==0){
                include 'db.php';
                  $qry2="INSERT INTO user_details() VALUES(null,'$signup_user','$signup_email','$signup_pass_hash')";
                  mysqli_query($con,$qry2);
                  $qry3="SELECT user_id FROM user_details WHERE user_email='$signup_email'";
